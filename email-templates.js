        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="padding: 30px; background: #f9fafb;">
                ...
                <div style="background: white; padding: 20px; border-radius: 8px; margin: 20px 0; border: 2px solid #e5e7eb;">
                    ...
                    <p><strong>Timeline:</strong> ${lead.timeline === 'asap' ? 'Priority Delivery (ASAP)' : lead.timeline.replace('-', ' to ').charAt(0).toUpperCase() + lead.timeline.replace('-', ' to ').slice(1)}</p>
                </div>
    ...
    return `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="background: #1f2937; padding: 20px; text-align: center;">
                ...
                <p style="color: #9ca3af; margin: 10px 0; font-size: 12px;">
                    Lead ID: ${lead._id || 'TEST-' + Date.now()} | Unsubscribe | Update Preferences
                </p>
            </div>
        </div>
    `;
